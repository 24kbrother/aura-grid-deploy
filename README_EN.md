...
**Aura Grid** is a high-performance, aesthetically premium smart home dashboard engine designed for the ultimate Home Assistant experience. Built for hardware terminals and tablet displays.
...
| :--- | :---: | :---: |
| **Visual Aesthetics** | Premium Dark Mode | Ultra-Smooth Animations |
| **Device Control** | Basic Toggle / Dimming | Full Domain Support (Climate/Media) |
| **Multi-Floor Support** | Single Floor | Unlimited Floors + Switching |
| **Third-party Pages** | 1 Embedded Page | Unlimited Custom Embeds |
| **Aura Guard Security** | Basic Protection | **3-Strikes IP Ban + Global Sync** |
| **Automation Link** | Manual Only | **Full Node-RED / Webhook Integration** |
| **Commercial Support** | Community Only | Priority VIP Support |
